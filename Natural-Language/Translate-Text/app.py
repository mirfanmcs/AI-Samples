...
def main():
    ...
    translate_region = os.getenv("TRANSLATE_SERVICE_REGION", "")            
    translate_key = os.getenv("TRANSLATE_SERVICE_KEY", "")       
    

    # Create client using endpoint and key
    credential = AzureKeyCredential(translate_key)
    client = TextTranslationClient(credential=credential, region=translate_region)
